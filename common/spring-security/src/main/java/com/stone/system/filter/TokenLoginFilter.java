package com.stone.system.filter;
...
import com.stone.common.utils.ResponseUtil;
import com.stone.model.vo.LoginVo;
import com.stone.system.custom.CustomUser;
import com.stone.system.service.AsyncLoginLogService;
import com.stone.system.utils.IpUtil;
...
public class TokenLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public TokenLoginFilter(AuthenticationManager authenticationManager,
                            ...
                            ,AsyncLoginLogService loginLogService) {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        //记录登录日志
        loginLogService.recordLoginLog(customUser.getUsername(),
